...
<button slot="ar-button" data-position="-0.8677595009568753m -0.3307609055865188m -1.0949358306581387m" data-normal="-0.365639403711054m -0.2441928036311423m 0.8981523818977418m">style="background-color: green; border-radius: 8px; border: 1 px solid black;<div id="reveal">In Person VIP Tour + Special Gift!</div></button> 
